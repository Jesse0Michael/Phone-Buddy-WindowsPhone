...
namespace PhoneBuddy 
{
    class actionSlider
    {
        ...
        public actionSlider(mouseHelp mouse, int screenWidth, int screenHeight)
        {
            this.sliderXloc = -25;
            this.mouse = mouse;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            this.recSliderPull = new Rectangle(sliderXloc + (int)((float)screenWidth * .22), (int)((float)screenHeight * .36), sliderPull.Width, sliderPull.Height);
            this.recFetch = new Rectangle(sliderXloc + (int)((float)screenWidth * .075), (int)((float)screenHeight * .04), actFetch.Width, actFetch.Height);
            this.recTug = new Rectangle(sliderXloc + (int)((float)screenWidth * .075), (int)((float)screenHeight * .24), actTug.Width, actTug.Height);
            this.recFood = new Rectangle(sliderXloc + (int)((float)screenWidth * .075), (int)((float)screenHeight * .43), actFood.Width, actFood.Height);
            this.recWater = new Rectangle(sliderXloc + (int)((float)screenWidth * .075), (int)((float)screenHeight * .62), actWater.Width, actWater.Height);
            this.recPoo = new Rectangle(sliderXloc + (int)((float)screenWidth * .09), (int)((float)screenHeight * .77), actPoo.Width, actPoo.Height);
